...
- Logo file is `tara-ptv-logo.png`; artwork now shows chrome "PTV" lettering (Aug 2026). Old `tara-nev-logo.png` deleted — if it reappears after a merge, delete it again.
